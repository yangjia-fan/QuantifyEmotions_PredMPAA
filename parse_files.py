...
def get_char_dial(script_noind, tag_vec, tag_set, char_max_words):
    ...
    if char_ind:
        ...
        # If char_ind is empty, just append the length of the script
        char_ind = [len(script_noind)]
...
if __name__ == "__main__":
    DIR_FINAL = join("scripts", "filtered_mpaa")
    ...
    for script in tqdm(meta):
        ...
        try:
            ...
            #print(err)
            print(f"Error occurred in script: {script}")
